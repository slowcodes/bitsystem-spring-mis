...
public class PatientCommand {
    ...
    private PatientReferralCommand patientReferralCommand;
    ...
    private DonationRegistryCommand donationRegistryCommand;
    ...
    private CompanyFolderCommand companyFolderCommand;
