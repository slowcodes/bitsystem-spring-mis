...
public class OutpatientPrescripAdmCmdToOutpatientPrescripAdm implements Converter<OutpatientPrescriptionAdministration, OutpatientPrescriptionAdministrationCommand> {
    @Override
