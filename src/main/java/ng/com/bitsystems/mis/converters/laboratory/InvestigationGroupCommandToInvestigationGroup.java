...
public class InvestigationGroupCommandToInvestigationGroup implements Converter<InvestigationGroupCommand, InvestigationGroups> {
    ...
    public InvestigationGroupCommandToInvestigationGroup(
            //LaboratoryCommandToLaboratory laboratoryCommandToLaboratory,
...
//                    investigationGroups.getInvestigations().add(laboratoryInvestigationCommandToLaboratoryInvestigation.convert(laboratoryInvestigationCommand)));
