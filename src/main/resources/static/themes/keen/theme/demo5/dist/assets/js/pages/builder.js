...
var KTLayoutBuilder = function() {
			...
			$.ajax('/keen/preview/index.php', {
				...
				var timer = setInterval(function() {
					$.ajax('/keen/preview/index.php', {
						...
						$('<iframe/>').attr({
							src: '/keen/preview/index.php?builder_export&builder_download&id=' + result.id,
	...
	var preview = function() {
		$('[name="builder_submit"]').click(function(e) {
			...
			$.ajax('/keen/preview/index.php?demo=' + $(_self).data('demo'), {
				method: 'POST',
				data: $('[name]').serialize(),
			}).done(function(r) {
	...
	var verify = {
		reCaptchaVerified: function() {
			return $.ajax('/keen/tools/builder/recaptcha.php?recaptcha', {
				method: 'POST',
				data: {
