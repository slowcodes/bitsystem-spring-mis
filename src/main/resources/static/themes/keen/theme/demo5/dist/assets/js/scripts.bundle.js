...
var KTApp = (function () {
    var t = {},
        e = function (t) {
            ...
            t.tooltip({ trigger: n, template: '<div class="tooltip ' + e + " " + a + '" role="tooltip">                <div class="arrow"></div>                <div class="tooltip-inner"></div>            </div>' });
        },
        a = function () {
        ...
        block: function (t, e) {
            var a,
                ...
                o =
                    ...
                    ((e = $.extend(!0, { opacity: 0.05, overlayColor: "#000000", type: "", size: "", state: "brand", centerX: !0, centerY: !0, message: "", shadow: !0, width: "auto" }, e)).type ? "kt-spinner--" + e.type : "") +
                    " " +
        ...
        i = {
            ...
            show: function () {
                return (
                    ...
                    "top center" == a.options.placement && KTUtil.addClass(e, "kt-dialog--top-center"),
                        n.appendChild(e),
                        (a.state = "shown"),
                ...
                build: function () {
                    ...
                    window.addEventListener("scroll", function () {
                        ...
                        KTUtil.isInResponsiveRange("desktop")
                            ? ((s = a.options.offset.desktop), (n = a.options.minimize.desktop.on), (i = a.options.minimize.desktop.off))
                            : KTUtil.isInResponsiveRange("tablet-and-mobile") && ((s = a.options.offset.mobile), (n = a.options.minimize.mobile.on), (i = a.options.minimize.mobile.off)),
                            (r = KTUtil.getScrollTop()),
                            (KTUtil.isInResponsiveRange("tablet-and-mobile") && a.options.classic && a.options.classic.mobile) || (KTUtil.isInResponsiveRange("desktop") && a.options.classic && a.options.classic.desktop)
                                ? r > s
                                ? (KTUtil.addClass(o, n), KTUtil.removeClass(o, i), e && (l.eventTrigger("minimizeOn", a), (e = !1)))
                                : (KTUtil.addClass(o, i), KTUtil.removeClass(o, n), 0 == e && (l.eventTrigger("minimizeOff", a), (e = !0)))
                                : (r > s && t < r
                                ? (KTUtil.addClass(o, n), KTUtil.removeClass(o, i), e && (l.eventTrigger("minimizeOn", a), (e = !1)))
                                : (KTUtil.addClass(o, i), KTUtil.removeClass(o, n), 0 == e && (l.eventTrigger("minimizeOff", a), (e = !0))),
                                    (t = r));
    ...
    if (o) {
        var l = { scroll: { rememberPosition: !1 }, accordion: { slideSpeed: 200, autoScroll: !1, autoScrollSpeed: 1200, expandAll: !0 }, dropdown: { timeout: 500 } },
            r = {
                ...
                build: function () {
                    (a.eventHandlers.event_1 = KTUtil.on(o, ".kt-menu__toggle", "click", r.handleSubmenuAccordion)),
                    ("dropdown" === r.getSubmenuMode() || r.isConditionalSubmenuDropdown()) &&
                    ((a.eventHandlers.event_2 = KTUtil.on(o, '[data-ktmenu-submenu-toggle="hover"]', "mouseover", r.handleSubmenuDrodownHoverEnter)),
                        (a.eventHandlers.event_3 = KTUtil.on(o, '[data-ktmenu-submenu-toggle="hover"]', "mouseout", r.handleSubmenuDrodownHoverExit)),
                        (a.eventHandlers.event_4 = KTUtil.on(o, '[data-ktmenu-submenu-toggle="click"] > .kt-menu__toggle, [data-ktmenu-submenu-toggle="click"] > .kt-menu__link .kt-menu__toggle', "click", r.handleSubmenuDropdownClick)),
                        (a.eventHandlers.event_5 = KTUtil.on(o, '[data-ktmenu-submenu-toggle="tab"] > .kt-menu__toggle, [data-ktmenu-submenu-toggle="tab"] > .kt-menu__link .kt-menu__toggle', "click", r.handleSubmenuDropdownTabClick))),
                        (a.eventHandlers.event_6 = KTUtil.on(o, ".kt-menu__item > .kt-menu__link:not(.kt-menu__toggle):not(.kt-menu__link--toggle-skip)", "click", r.handleLinkClick)),
                ...
                scrollInit: function () {
                    a.options.scroll && a.options.scroll.height
                        ? (KTUtil.scrollDestroy(o),
                            KTUtil.scrollInit(o, { mobileNativeScroll: !0, windowScroll: !1, resetHeightOnDestroy: !0, handleWindowResize: !0, height: a.options.scroll.height, rememberPosition: a.options.scroll.rememberPosition }))
                        : KTUtil.scrollDestroy(o);
                },
                ...
                getSubmenuMode: function (t) {
                    return KTUtil.isInResponsiveRange("desktop")
                        ? t && KTUtil.hasAttr(t, "data-ktmenu-submenu-toggle") && "hover" == KTUtil.attr(t, "data-ktmenu-submenu-toggle")
                            ? "dropdown"
                            : KTUtil.isset(a.options.submenu, "desktop.state.body")
                                ...
                                : KTUtil.isset(a.options.submenu, "desktop")
                                    ...
                                    : void 0
                        : KTUtil.isInResponsiveRange("tablet") && KTUtil.isset(a.options.submenu, "tablet")
                            ? a.options.submenu.tablet
                            : !(!KTUtil.isInResponsiveRange("mobile") || !KTUtil.isset(a.options.submenu, "mobile")) && a.options.submenu.mobile;
                },
                ...
                handleSubmenuDropdownClick: function (t) {
                    if ("accordion" !== r.getSubmenuMode(this)) {
                        ...
                        (!1 === KTUtil.hasClass(e, "kt-menu__item--hover")
                            ? (KTUtil.addClass(e, "kt-menu__item--open-dropdown"), r.showSubmenuDropdown(e))
                            : (KTUtil.removeClass(e, "kt-menu__item--open-dropdown"), r.hideSubmenuDropdown(e, !0)),
                            t.preventDefault());
                    }
                },
                ...
                handleSubmenuDropdownClose: function (t, e) {
                    if ("accordion" !== r.getSubmenuMode(e)) {
                        ...
                        if (a.length > 0 && !1 === KTUtil.hasClass(e, "kt-menu__toggle") && 0 === e.querySelectorAll(".kt-menu__toggle").length) for (var n = 0, i = a.length; n < i; n++) r.hideSubmenuDropdown(a[0], !0);
                    }
                },
                ...
                hideSubmenuDropdown: function (t, e) {
                    e && (KTUtil.removeClass(t, "kt-menu__item--hover"), KTUtil.removeClass(t, "kt-menu__item--active-tab")),
                        t.removeAttribute("data-hover"),
                    t.getAttribute("data-ktmenu-dropdown-toggle-class") && KTUtil.removeClass(i, t.getAttribute("data-ktmenu-dropdown-toggle-class"));
                    var a = t.getAttribute("data-timeout");
                    t.removeAttribute("data-timeout"), clearTimeout(a);
                },
                hideSubmenuDropdowns: function () {
                    var t;
                    if ((t = o.querySelectorAll('.kt-menu__item--submenu.kt-menu__item--hover:not(.kt-menu__item--tabs):not([data-ktmenu-submenu-toggle="tab"])'))) for (var e = 0, a = t.length; e < a; e++) r.hideSubmenuDropdown(t[e], !0);
                },
                ...
                createSubmenuDropdownClickDropoff: function (t) {
                    var e,
                        a = (e = KTUtil.child(t, ".kt-menu__submenu") ? KTUtil.css(e, "z-index") : 0) - 1,
                ...
                resetActiveItem: function (t) {
                    ...
                    if (!1 === a.options.accordion.expandAll && (e = o.querySelectorAll(".kt-menu__item--open"))) for (i = 0, l = e.length; i < l; i++) KTUtil.removeClass(n[0], "kt-menu__item--open");
                },
            ...
            l = {
                    ...
                    if (a.options.toggleBy)
                        if ("string" == typeof a.options.toggleBy)
                            ...
                            if (a.options.toggleBy[0].target)
                                ...
                                for (var t in a.options.toggleBy)
                                    KTUtil.addEvent(a.options.toggleBy[t], "click", function (t) {
                                        t.preventDefault(), l.toggle();
                                    });
                        else
                            a.options.toggleBy &&
                            a.options.toggleBy.target &&
                            KTUtil.addEvent(a.options.toggleBy.target, "click", function (t) {
                                t.preventDefault(), l.toggle();
                            });
                ...
                show: function (t) {
                    ...
                    (l.eventTrigger("beforeShow"),
                        ...
                        (a.state = "shown"),
                    a.options.overlay &&
                    ((a.overlay = KTUtil.insertAfter(document.createElement("DIV"), n)),
            ...
            l = {
                ...
                init: function (t) {
                    (a.element = n),
                        ...
                        KTUtil.child(n, ".kt-portlet__body") ? (a.body = KTUtil.child(n, ".kt-portlet__body")) : KTUtil.child(n, ".kt-form") && (a.body = KTUtil.child(n, ".kt-form"));
                },
                build: function () {
                ...
                onScrollSticky: function (t) {
                    ...
                    if (!isNaN(e)) {
                        ...
                        i >= e && !1 === KTUtil.hasClass(o, "kt-portlet--sticky")
                            ? (l.eventTrigger("stickyOn"), KTUtil.addClass(o, "kt-portlet--sticky"), KTUtil.addClass(n, "kt-portlet--sticky"), l.updateSticky())
                            : 1.5 * i <= e && KTUtil.hasClass(o, "kt-portlet--sticky") && (l.eventTrigger("stickyOff"), KTUtil.removeClass(o, "kt-portlet--sticky"), KTUtil.removeClass(n, "kt-portlet--sticky"), l.resetSticky());
                    }
                },
                ...
                remove: function () {
                    ...
                    (KTUtil.hasClass(o, "kt-portlet--fullscreen") && KTUtil.hasClass(n, "kt-portlet--fullscreen") && l.fullscreen("off"), l.removeTooltips(), KTUtil.remove(n), l.eventTrigger("afterRemove"));
                },
                ...
                fullscreen: function (t) {
                    if ("off" === t || (KTUtil.hasClass(o, "kt-portlet--fullscreen") && KTUtil.hasClass(n, "kt-portlet--fullscreen")))
                        l.eventTrigger("beforeFullscreenOff"),
                            ...
                            l.removeTooltips(),
                            l.setupTooltips(),
                        a.foot && (KTUtil.css(a.body, "margin-bottom", ""), KTUtil.css(a.foot, "margin-top", "")),
            ...
            i = {
                ...
                init: function (t) {
                    (a.element = n),
                        ...
                        (a.state = KTUtil.hasClasses(a.target, a.targetState) ? "on" : "off");
                },
                build: function () {
...
var KTUtil = (function () {
    ...
    return {
        ...
        addClass: function (t, e) {
            if (t && void 0 !== e) {
                var a = e.split(" ");
                if (t.classList) for (var n = 0; n < a.length; n++) a[n] && a[n].length > 0 && t.classList.add(KTUtil.trim(a[n]));
                else if (!KTUtil.hasClass(t, e)) for (var o = 0; o < a.length; o++) t.className += " " + KTUtil.trim(a[o]);
            }
        },
        removeClass: function (t, e) {
            if (t && void 0 !== e) {
                var a = e.split(" ");
                if (t.classList) for (var n = 0; n < a.length; n++) t.classList.remove(KTUtil.trim(a[n]));
                else if (KTUtil.hasClass(t, e)) for (var o = 0; o < a.length; o++) t.className = t.className.replace(new RegExp("\\b" + KTUtil.trim(a[o]) + "\\b", "g"), "");
            }
        },
                ...
                (t = KTUtil.get(t)),
                    {
                        set: function (e, a) {
                            null != t &&
                            void 0 !== t &&
                            (void 0 === t.customDataTag && (window.KTUtilElementDataStoreID++, (t.customDataTag = window.KTUtilElementDataStoreID)),
                            void 0 === window.KTUtilElementDataStore[t.customDataTag] && (window.KTUtilElementDataStore[t.customDataTag] = {}),
                                (window.KTUtilElementDataStore[t.customDataTag][e] = a));
                        },
                        get: function (e) {
        ...
        slide: function (t, e, a, n, o) {
            if (!(!t || ("up" == e && !1 === KTUtil.visible(t)) || ("down" == e && !0 === KTUtil.visible(t)))) {
                ...
                var i = KTUtil.actualHeight(t),
                    l = !1,
                    r = !1;
                KTUtil.css(t, "padding-top") && !0 !== KTUtil.data(t).has("slide-padding-top") && KTUtil.data(t).set("slide-padding-top", KTUtil.css(t, "padding-top")),
                KTUtil.css(t, "padding-bottom") && !0 !== KTUtil.data(t).has("slide-padding-bottom") && KTUtil.data(t).set("slide-padding-bottom", KTUtil.css(t, "padding-bottom")),
                KTUtil.data(t).has("slide-padding-top") && (l = parseInt(KTUtil.data(t).get("slide-padding-top"))),
                KTUtil.data(t).has("slide-padding-bottom") && (r = parseInt(KTUtil.data(t).get("slide-padding-bottom"))),
                    "up" == e
        ...
        on: function (t, e, a, n) {
            if (e) {
                ...
                return (
                    (window.KTUtilDelegatedEventHandlers[o] = function (a) {
                        for (var o = t.querySelectorAll(e), i = a.target; i && i !== t; ) {
                            for (var l = 0, r = o.length; l < r; l++) i === o[l] && n.call(i, a);
                            i = i.parentNode;
                        }
                    }),
                        KTUtil.addEvent(t, a, window.KTUtilDelegatedEventHandlers[o]),
                        o
                );
            }
        },
        ...
        scrollInit: function (t, e) {
            function a() {
                var a, n;
                if (((n = e.height instanceof Function ? parseInt(e.height.call()) : parseInt(e.height)), (e.mobileNativeScroll || e.disableForMobile) && KTUtil.isInResponsiveRange("tablet-and-mobile")))
                    (a = KTUtil.data(t).get("ps"))
                        ? (e.resetHeightOnDestroy ? KTUtil.css(t, "height", "auto") : (KTUtil.css(t, "overflow", "auto"), n > 0 && KTUtil.css(t, "height", n + "px")), a.destroy(), (a = KTUtil.data(t).remove("ps")))
                        : n > 0 && (KTUtil.css(t, "overflow", "auto"), KTUtil.css(t, "height", n + "px"));
            ...
            i = {
                ...
                init: function (t) {
                    (a.element = n),
                        ...
                        (a.btnSubmit = KTUtil.find(n, '[data-ktwizard-type="action-submit"]')),
                        (a.btnNext = KTUtil.find(n, '[data-ktwizard-type="action-next"]')),
                        (a.btnPrev = KTUtil.find(n, '[data-ktwizard-type="action-prev"]')),
                        (a.btnLast = KTUtil.find(n, '[data-ktwizard-type="action-last"]')),
                        (a.btnFirst = KTUtil.find(n, '[data-ktwizard-type="action-first"]')),
                        (a.events = []),
                        (a.currentStep = 1),
                        (a.stopped = !1),
                ...
                build: function () {
                    ...
                    KTUtil.on(n, '[data-ktwizard-type="step"]', "click", function () {
                ...
                updateUI: function () {
                    ...
                    if (r && r.length > 0) for (o = 0, l = r.length; o < l; o++) o == e ? KTUtil.attr(r[o], "data-ktwizard-state", "current") : KTUtil.removeAttr(r[o], "data-ktwizard-state");
                    var s = KTUtil.findAll(a.element, '[data-ktwizard-type="step-content"]');
                    if (s && s.length > 0) for (o = 0, l = s.length; o < l; o++) o == e ? KTUtil.attr(s[o], "data-ktwizard-state", "current") : KTUtil.removeAttr(s[o], "data-ktwizard-state");
                },
            ...
            if (0 !== t(this).length) {
                ...
                var l = {
                    ...
                    layoutUpdate: function () {
                        ...
                        void 0 === o.detail && 1 === l.getDepth() && l.lockTable.call(),
                            l.resetScroll(),
                        l.isLocked() || (l.redraw.call(), l.isSubtable() || !0 !== l.getOption("rows.autoHide") || l.autoHide(), t(i.table).find(".kt-datatable__row").css("height", "")),
                            l.columnHide.call(),
                            l.rowEvenOdd.call(),
                            l.sorting.call(),
                            l.scrollbar.call(),
                        l.isInit || (l.dropdownFix(), t(i).trigger("kt-datatable--on-init", { table: t(i.wrap).attr("id"), options: o }), (l.isInit = !0)),
                            t(i).trigger("kt-datatable--on-layout-updated", { table: t(i.wrap).attr("id") });
                    },
                    dropdownFix: function () {
                        var e;
                        t("body")
                            .on("show.bs.dropdown", ".kt-datatable .kt-datatable__body", function (a) {
                                        ...
                                        t(this).ready(function () {
                                            !(function (a) {
                                                if (t(a).find(".kt-datatable__lock").length > 0) l.log("Locked container already exist in: ", a);
                                                    ...
                                                    e.lockEnabled.left.length > 0 && (t(i.wrap).addClass("kt-datatable--lock"), t(n).appendTo(a)),
                                                    (e.lockEnabled.left.length > 0 || e.lockEnabled.right.length > 0) && t(o).appendTo(a),
                                                    e.lockEnabled.right.length > 0 && (t(i.wrap).addClass("kt-datatable--lock"), t(r).appendTo(a));
                    ...
                    setupBaseDOM: function () {
                        (i.initialDatatable = t(i).clone()),
                            "TABLE" === t(i).prop("tagName")
                                ? ((i.table = t(i).removeClass("kt-datatable").addClass("kt-datatable__table")),
                                ...
                                : ((i.wrap = t(i)
                                    .addClass("kt-datatable")
                                    .addClass("kt-datatable--" + o.layout.theme)),
                                    (i.table = t("<table/>").addClass("kt-datatable__table").appendTo(i))),
                        void 0 !== o.layout.class && t(i.wrap).addClass(o.layout.class),
                            t(i.table).removeClass("kt-datatable--destroyed").css("display", "block"),
                        void 0 === t(i).attr("id") && (l.setOption("data.saveState", !1), t(i.table).attr("id", a.getUniqueID("kt-datatable--"))),
                            ...
                            init: function () {
                                ...
                                if (o.layout.scroll) {
                                    ...
                                    t(r).find(".kt-datatable__row").length > 0 && t(r).length > 0
                                        ? ((e.scrollHead = t(i.tableHead).find("> .kt-datatable__lock--scroll > .kt-datatable__row")),
                                            (e.scrollFoot = t(i.tableFoot).find("> .kt-datatable__lock--scroll > .kt-datatable__row")),
                                            (e.tableLocked = t(i.tableBody).find(".kt-datatable__lock:not(.kt-datatable__lock--scroll)")),
                                        ...
                                        ((e.scrollHead = t(i.tableHead).find("> .kt-datatable__row")),
                                            (e.scrollFoot = t(i.tableFoot).find("> .kt-datatable__row")),
                    ...
                    dataRender: function (e) {
                        ...
                        var a = function () {
                            ...
                            n = function (e) {
                                var n = function (e, a) {
                                    t(e.pager).hasClass("kt-datatable--paging-loaded") || (t(e.pager).remove(), e.init(a)),
                                        t(e.pager)
                                            .off()
                        ...
                        if (
                            (t.each(i.dataSet, function (n, r) {
                                ...
                                for (var p = 0; p < u; p += 1) {
                                    ...
                                    void 0 !== f.autoHide && (!0 !== f.autoHide ? m.setAttribute("data-autohide-disabled", f.autoHide) : m.setAttribute("data-autohide-enabled", f.autoHide)),
                                        (m.innerHTML = l.getObject(f.field, r)),
                                        m.setAttribute("aria-label", l.getObject(f.field, r)),
                                        s.appendChild(m);
                                }
                                c.appendChild(s);
                            }),
                        ...
                        return t
                            ...
                            .fail(function (e, a, n) {
                                t(i).trigger("kt-datatable--on-ajax-fail", [e]),
                                    t(i.tableBody).html(t("<span/>").addClass("kt-datatable--error").html(l.getOption("translate.records.noRecords"))),
                    ...
                    paging: function (e, n) {
                        var o = {
                            ...
                            init: function (e) {
                                ...
                                (t(o.pager).remove(),
                                0 !== o.meta.pages &&
                                (l.setDataSourceParam("pagination", { page: o.meta.page, pages: o.meta.pages, perpage: o.meta.perpage, total: o.meta.total }),
                            ...
                            populate: function () {
                                ...
                                (o.pagerLayout.pagination = n),
                                    t("<li/>")
                                        .append(t("<a/>").attr("title", a.first).addClass("kt-datatable__pager-link kt-datatable__pager-link--first").append(t("<i/>").addClass(e.first)).on("click", o.gotoMorePage).attr("data-page", 1))
                                        .appendTo(n),
                                    t("<li/>")
                                        .append(t("<a/>").attr("title", a.prev).addClass("kt-datatable__pager-link kt-datatable__pager-link--prev").append(t("<i/>").addClass(e.prev)).on("click", o.gotoMorePage))
                                        .appendTo(n),
                                    t("<li/>")
                                        .append(t("<a/>").attr("title", a.more).addClass("kt-datatable__pager-link kt-datatable__pager-link--more-prev").html(t("<i/>").addClass(e.more)).on("click", o.gotoMorePage))
                                        .appendTo(n),
                                    t("<li/>")
                                        .append(
                                            t("<input/>")
                                ...
                                t("<li/>")
                                    .append(t("<a/>").attr("title", a.more).addClass("kt-datatable__pager-link kt-datatable__pager-link--more-next").html(t("<i/>").addClass(e.more)).on("click", o.gotoMorePage))
                                    .appendTo(n),
                                    t("<li/>")
                                        .append(t("<a/>").attr("title", a.next).addClass("kt-datatable__pager-link kt-datatable__pager-link--next").append(t("<i/>").addClass(e.next)).on("click", o.gotoMorePage))
                                        .appendTo(n),
                                    t("<li/>")
                                        .append(
                                            t("<a/>").attr("title", a.last).addClass("kt-datatable__pager-link kt-datatable__pager-link--last").append(t("<i/>").addClass(e.last)).on("click", o.gotoMorePage).attr("data-page", o.meta.pages)
                                        )
                                        .appendTo(n),
                                l.getOption("toolbar.items.info") && (o.pagerLayout.info = t("<div/>").addClass("kt-datatable__pager-info").append(t("<span/>").addClass("kt-datatable__pager-detail"))),
                            ...
                            updatePerpage: function (e) {
                                e.preventDefault(),
                                    ...
                                    (o.pager = t(i.table).siblings(".kt-datatable__pager").removeClass("kt-datatable--paging-loaded")),
                                e.originalEvent && (o.meta.perpage = parseInt(t(this).val())),
                                    t(o.pager).find("select.kt-datatable__pager-size").val(o.meta.perpage).attr("data-selected", o.meta.perpage),
                                    l.setDataSourceParam("pagination", { page: o.meta.page, pages: o.meta.pages, perpage: o.meta.perpage, total: o.meta.total }),
                            ...
                            addPaginateEvent: function (e) {
                                t(i)
                                    ...
                                    .on(o.paginateEvent, function (e, a) {
                                        ...
                                        t(n).find(".kt-datatable__pager-link--active").removeClass("kt-datatable__pager-link--active"),
                                            t(n)
                                                .find('.kt-datatable__pager-link-number[data-page="' + a.page + '"]')
                                            ...
                                            l.setDataSourceParam("pagination", { page: o.meta.page, pages: o.meta.pages, perpage: o.meta.perpage, total: o.meta.total }),
                                            t(o.pager).find("select.kt-datatable__pager-size").val(a.perpage).attr("data-selected", a.perpage),
                                            t(i.table).find('.kt-checkbox > [type="checkbox"]').prop("checked", !1),
                                            t(i.table).find(".kt-datatable__row--active").removeClass("kt-datatable__row--active"),
                                            o.updateInfo.call(),
                                            o.pagingBreakpoint.call();
                                    });
                            },
                                        ...
                                        t.each(l.getOption("toolbar.items.pagination.pages"), function (i, s) {
                                            if (a.isInResponsiveRange(i)) {
                                                switch (i) {
                                                    ...
                                                    case "mobile":
                                                        t(r).show(),
                                                            t(e).find(".kt-datatable__pager-link--more-prev").closest("li").hide(),
                            ...
                            paginationUpdate: function () {
                                ...
                                t(n).each(function (e, a) {
                                    ...
                                    1 === o.meta.page
                                        ? (t(r).attr("disabled", !0).addClass("kt-datatable__pager-link--disabled"), t(s).attr("disabled", !0).addClass("kt-datatable__pager-link--disabled"))
                                        : (t(r).removeAttr("disabled").removeClass("kt-datatable__pager-link--disabled"), t(s).removeAttr("disabled").removeClass("kt-datatable__pager-link--disabled")),
                                    o.meta.page === o.meta.pages
                                        ? (t(d).attr("disabled", !0).addClass("kt-datatable__pager-link--disabled"), t(c).attr("disabled", !0).addClass("kt-datatable__pager-link--disabled"))
                                        : (t(d).removeAttr("disabled").removeClass("kt-datatable__pager-link--disabled"), t(c).removeAttr("disabled").removeClass("kt-datatable__pager-link--disabled"));
                        ...
                        if ("function" == typeof e && !(t(i.table).find(".kt-datatable__subtable").length > 0)) {
                            ...
                            var a = function (a) {
                                    ...
                                    ((r = t("<tr/>").addClass("kt-datatable__row-subtable kt-datatable__row-loading").hide().append(t("<td/>").addClass("kt-datatable__subtable").attr("colspan", l.getTotalColumns()))),
                                        t(n).after(r),
                                    t(n).hasClass("kt-datatable__row--even") && t(r).addClass("kt-datatable__row-subtable--even")),
                                        t(r).toggle();
                                    ...
                                    t(n).hasClass("kt-datatable__row--subtable-expanded")
                                        ? (t(c).addClass(l.getOption("layout.icons.rowDetail.collapse")), t(n).removeClass("kt-datatable__row--subtable-expanded"), t(i).trigger("kt-datatable--on-collapse-subtable", [n]))
                                        : (t(c).addClass(l.getOption("layout.icons.rowDetail.expand")), t(n).addClass("kt-datatable__row--subtable-expanded"), t(i).trigger("kt-datatable--on-expand-subtable", [n])),
                                ...
                                t(i).each(function () {
                                    ...
                                    t(s).append(
                                        t('<tr class="kt-datatable__row"></tr>')
                                            .append(t('<td class="kt-datatable__cell"></td>').append(t("<span/>").append(a.title)))
                                            .append(this)
                                    );
                                }),
                                    t(r).append(s);
                            ...
                            t(i.tableBody)
                                ...
                                .each(function () {
                                    ...
                                    t(this).prepend(
                                        ...
                                        0 === t(i.tableHead).find(".kt-datatable__toggle-detail").length
                                            ? (t(i.tableHead).find(".kt-datatable__row").first().prepend('<th class="kt-datatable__cell kt-datatable__toggle-detail"><span></span></th>'),
                                                t(i.tableFoot).find(".kt-datatable__row").first().prepend('<th class="kt-datatable__cell kt-datatable__toggle-detail"><span></span></th>'))
                                            : t(i.tableHead).find(".kt-datatable__toggle-detail").find("span");
                                });
                        }),
                    ...
                    setAutoColumns: function () {
                        ...
                        (t.each(i.dataSet[0], function (e, a) {
                            ...
                            l.setHeadTitle(),
                        l.getOption("layout.footer") && (t(i.tableFoot).find(".kt-datatable__row").remove(), l.setHeadTitle(i.tableFoot)));
                    },
                    isLocked: function () {
                        ...
                        var e = {
                            ...
                            sortClick: function (n) {
                                ...
                                if (
                                    ...
                                    (t(i.tableHead).find("th").removeClass("kt-datatable__cell--sorted"), a.addClass(this, "kt-datatable__cell--sorted"), t(i.tableHead).find(".kt-datatable__cell > span > i").remove(), o.sortable)
                                ) {
                                    l.spinnerCallback(!0);
                                    var c = "desc";
                    ...
                    rowEvenOdd: function () {
                        t(i.tableBody).find(".kt-datatable__row").removeClass("kt-datatable__row--even"),
                            t(i.wrap).hasClass("kt-datatable--subtable")
                                ? t(i.tableBody).find(".kt-datatable__row:not(.kt-datatable__row-detail):even").addClass("kt-datatable__row--even")
                                : t(i.tableBody).find(".kt-datatable__row:nth-child(even)").addClass("kt-datatable__row--even");
                    },
                    timer: 0,
                    redraw: function () {
                    ...
                    setDataSourceParam: function (e, a) {
                        (i.API.params = t.extend({}, { pagination: { page: 1, perpage: l.getOption("data.pageSize") }, sort: l.getDefaultSortColumn(), query: {} }, i.API.params, l.stateGet(l.stateId))),
                    ...
                    rows: function (e) {
                        return (
                            l.isLocked() ? (l.nodeTr = l.recentNode = t(i.tableBody).find(e).filter(".kt-datatable__lock--scroll > .kt-datatable__row")) : (l.nodeTr = l.recentNode = t(i.tableBody).find(e).filter(".kt-datatable__row")), i
                        );
                    },
                    column: function (e) {
                ...
                if (
                    ...
                    if ("string" == typeof o) {
                        ...
                        ((i.dataSet = null),
                            (i.textAlign = { left: "kt-datatable__cell--left", center: "kt-datatable__cell--center", right: "kt-datatable__cell--right" }),
            ...
            (t.fn.KTDatatable.defaults = {
                ...
                layout: {
                    ...
                    icons: {
                        ...
                        pagination: { next: "flaticon2-next", prev: "flaticon2-back", first: "flaticon2-fast-back", last: "flaticon2-fast-next", more: "flaticon-more-1" },
                ...
                rows: { callback: function () {}, beforeTemplate: function () {}, afterTemplate: function () {}, autoHide: !0 },
                toolbar: {
                    ...
                    items: {
                        pagination: {
                            type: "default",
                            pages: { desktop: { layout: "default", pagesNumber: 5 }, tablet: { layout: "default", pagesNumber: 3 }, mobile: { layout: "compact" } },
                ...
                translate: {
                    ...
                    toolbar: {
                        pagination: {
                            items: {
                                default: { first: "First", prev: "Previous", next: "Next", last: "Last", more: "More pages", input: "Page number", select: "Select page size", all: "all" },
        ...
        (t.fn.KTDatatable = t.fn.KTDatatable || {}),
            (t.fn.KTDatatable.checkbox = function (e, a) {
                var n = {
                        ...
                        t(e.tableHead)
                            ...
                            t(e.tableBody)
                                ...
                                .click(function (o) {
                                    ...
                                    !a.vars.requestIds && n.selectedRows.length < 1 && t(e.tableHead).find('.kt-checkbox--all > [type="checkbox"]').prop("checked", !1);
                                    var l = {};
                    ...
                    initSelect: function () {
                        n.selectedAllRows && a.vars.requestIds
                            ? (e.hasClass("kt-datatable--error") || t(e.tableHead).find('.kt-checkbox--all > [type="checkbox"]').prop("checked", !0),
                                e.setActiveAll(!0),
                            ...
                            t(e.tableBody).find('.kt-checkbox--single > [type="checkbox"]').not(":checked").length < 1 &&
                            t(e.tableHead).find('.kt-checkbox--all > [type="checkbox"]').prop("checked", !0));
                    },
                ...
                return (
                    ...
                    "object" == typeof a && ((a = t.extend(!0, {}, t.fn.KTDatatable.checkbox.default, a)), n.init.apply(this, [a])),
                        e
                );
            }),
            (t.fn.KTDatatable.checkbox.default = { vars: { selectedAllRows: "selectedAllRows", requestIds: "requestIds", rowIds: "meta.rowIds" } });
    })(jQuery);
var defaults = {
    layout: {
...
var KTAsideSecondary = (function () {
    ...
    var t,
        e = KTUtil.get("kt_aside_secondary_tab_1"),
        ...
        r = function (t) {
            var e,
                a = KTUtil.find(t, ".kt-aside-secondary__content-head");
            KTUtil.find(t, ".kt-aside-secondary__content-body");
            return (
                (e = parseInt(KTUtil.getViewPort().height) - parseInt(KTUtil.actualHeight(a)) - 60),
                    KTUtil.isInResponsiveRange("desktop") ? (e -= KTUtil.actualHeight(KTUtil.get("kt_header"))) : (e -= KTUtil.actualHeight(KTUtil.get("kt_header_mobile"))),
                    e
            );
        };
    return {
        init: function () {
            $('#kt_aside_secondary_nav a[data-toggle="tab"]').on("click", function (e) {
                ...
                new KTToggle("kt_aside_secondary_mobile_nav_toggler", { target: "body", targetState: "kt-aside-secondary--mobile-nav-expanded" }),
                KTUtil.scrollInit(o, {
                    disableForMobile: !0,
...
var KTDemoPanel = (function () {
    ...
    return {
        init: function () {
            !(function () {
                t = new KTOffcanvas(e, { overlay: !0, baseClass: "kt-demo-panel", closeBy: "kt_demo_panel_close", toggleBy: "kt_demo_panel_toggle" });
                ...
                sticky: {
                    ...
                    position: {
                        top: function () {
                            ...
                            return (
                                KTUtil.isInResponsiveRange("desktop")
                                    ? KTUtil.hasClass(t, "kt-header--fixed") && (e += parseInt(KTUtil.css(KTUtil.get("kt_header"), "height")))
                                    : KTUtil.hasClass(t, "kt-header-mobile--fixed") && (e += parseInt(KTUtil.css(KTUtil.get("kt_header_mobile"), "height"))),
                                    e
                            );
                        },
                        left: function (t) {
    ...
    return {
        init: function () {
            (t = KTUtil.get("body")),
                ...
                $("#kt_aside_menu, #kt_header_menu").on("click", '.kt-menu__link[href="#"]:not(.kt-menu__toggle)', function (t) {
                    swal("", "You have clicked on a non-functional dummy link!"), t.preventDefault();
                });
        },
        initHeader: function () {
            var t, a, n;
            (a = KTUtil.get("kt_header")),
                (n = { offset: {}, minimize: {} }),
                "hide" == KTUtil.attr(a, "data-ktheader-minimize-mobile") ? ((n.minimize.mobile = {}), (n.minimize.mobile.on = "kt-header--hide"), (n.minimize.mobile.off = "kt-header--show")) : (n.minimize.mobile = !1),
                "hide" == KTUtil.attr(a, "data-ktheader-minimize") ? ((n.minimize.desktop = {}), (n.minimize.desktop.on = "kt-header--hide"), (n.minimize.desktop.off = "kt-header--show")) : (n.minimize.desktop = !1),
            (t = KTUtil.attr(a, "data-ktheader-minimize-offset")) && (n.offset.desktop = t),
            (t = KTUtil.attr(a, "data-ktheader-minimize-mobile-offset")) && (n.offset.mobile = t),
                new KTHeader("kt_header", n),
                ...
                new KTMenu("kt_header_menu", { submenu: { desktop: "dropdown", tablet: "accordion", mobile: "accordion" }, accordion: { slideSpeed: 200, expandAll: !1 } }),
                (o = new KTToggle("kt_header_mobile_topbar_toggler", { target: "body", targetState: "kt-header__topbar--mobile-on", togglerState: "kt-header-mobile__toolbar-topbar-toggler--active" })),
        ...
        initAside: function () {
            ...
            (t = KTUtil.get("kt_aside")),
                ...
                (e = KTUtil.hasClass(t, "kt-aside--offcanvas-default") ? "kt-aside--offcanvas-default" : "kt-aside"),
                (n = new KTOffcanvas("kt_aside", { baseClass: e, overlay: !0, closeBy: "kt_aside_close", toggleBy: { target: "kt_aside_toggler", state: "kt-subheader__toggler--active" } })),
                (function () {
                    var t,
                        e = KTUtil.get("kt_aside"),
                        n = KTUtil.get("kt_aside_menu");
                    KTUtil.attr(n, "data-ktmenu-dropdown");
                    "1" === KTUtil.attr(n, "data-ktmenu-scroll") &&
                    (t = {
                        rememberPosition: !0,
                        height: function () {
                            var t;
                            t = parseInt(KTUtil.getViewPort().height);
                            var a = KTUtil.find(e, ".kt-aside__head");
                            return (
                                a && ((t -= parseInt(KTUtil.actualHeight(a))), (t -= parseInt(KTUtil.css(a, "marginBottom")))),
                                    (t -= parseInt(KTUtil.css(n, "marginBottom")) + parseInt(KTUtil.css(n, "marginTop"))),
                                    (t -= parseInt(KTUtil.css(e, "paddingBottom")) + parseInt(KTUtil.css(e, "paddingTop")))
                            );
                        },
                    }),
                        (a = new KTMenu("kt_aside_menu", { scroll: t, submenu: { desktop: "accordion", tablet: "accordion", mobile: "accordion" }, accordion: { expandAll: !1 } }));
                })(),
    ...
    initMediumChart: function (t, e, a, n, o) {
        if (document.getElementById(t)) {
            ...
            var r = {
                    ...
                    data: {
                        labels: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October"],
                        datasets: [{ label: "Orders", borderColor: n, borderWidth: o, backgroundColor: l, pointBackgroundColor: KTApp.getStateColor("brand"), data: e }],
                    },
                    options: {
                        responsive: !0,
    ...
    return {
        init: function () {
            !(function () {
                ...
                new KTOffcanvas(t, { overlay: !0, baseClass: "kt-offcanvas-panel", closeBy: "kt_offcanvas_toolbar_notifications_close", toggleBy: "kt_offcanvas_toolbar_notifications_toggler_btn" });
                KTUtil.scrollInit(a, {
                    disableForMobile: !0,
                    resetHeightOnDestroy: !0,
                    handleWindowResize: !0,
                ...
                (function () {
                    ...
                    new KTOffcanvas(e, { overlay: !0, baseClass: "kt-offcanvas-panel", closeBy: "kt_offcanvas_toolbar_quick_actions_close", toggleBy: "kt_offcanvas_toolbar_quick_actions_toggler_btn" });
                    KTUtil.scrollInit(a, {
                        disableForMobile: !0,
                        resetHeightOnDestroy: !0,
                        handleWindowResize: !0,
                ...
                (function () {
                    ...
                    new KTOffcanvas(a, { overlay: !0, baseClass: "kt-offcanvas-panel", closeBy: "kt_offcanvas_toolbar_profile_close", toggleBy: "kt_offcanvas_toolbar_profile_toggler_btn" });
                    KTUtil.scrollInit(e, {
                        disableForMobile: !0,
                        resetHeightOnDestroy: !0,
                        handleWindowResize: !0,
                ...
                (function () {
                    ...
                    new KTOffcanvas(n, { overlay: !0, baseClass: "kt-offcanvas-panel", closeBy: "kt_offcanvas_toolbar_search_close", toggleBy: "kt_offcanvas_toolbar_search_toggler_btn" });
                    KTUtil.scrollInit(o, {
                        disableForMobile: !0,
                        resetHeightOnDestroy: !0,
                        handleWindowResize: !0,
...
var KTQuickPanel = (function () {
    ...
    return {
        init: function () {
            new KTOffcanvas(t, { overlay: !0, baseClass: "kt-offcanvas-panel", closeBy: "kt_quick_panel_close_btn", toggleBy: "kt_quick_panel_toggler_btn" }),
                KTUtil.scrollInit(e, {
                    disableForMobile: !0,
                    resetHeightOnDestroy: !0,
                    handleWindowResize: !0,
